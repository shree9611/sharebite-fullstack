        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 md:px-8 flex flex-col md:flex-row items-center gap-12">
          ...
          <div className="flex-1 text-center md:text-left">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center md:justify-start">
              <Link
                to="/disclaimer"
                className="bg-emerald-500 hover:bg-emerald-600 text-white px-10 py-3 rounded-xl font-bold text-center"
              >
                {t("Create Account")}
              </Link>
              ...
              <Link
                to="/login"
                className="border border-emerald-500 text-emerald-600 px-10 py-3 rounded-xl font-bold text-center hover:bg-emerald-50"
              >
                {t("Login")}
              </Link>
            </div>
